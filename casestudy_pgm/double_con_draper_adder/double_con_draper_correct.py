...
def double_con_draper_true(m : int) -> cirq.Circuit : # n for number of bits for a,b
...
def my_double_con_draper_true(m : int) -> cirq.Circuit : # n for number of bits for a,b
    con     = cirq.LineQubit.range(2)
    b_qbits = cirq.LineQubit.range(2, m+2)
    a_qbits = cirq.LineQubit.range(m+2, 2 *m+2)
...
if __name__=='__main__':
    print(double_con_draper_true(2))
    print(my_double_con_draper_true(2))